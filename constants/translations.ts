...
const en: Translations = {
  ...
  notifFriendAcceptedBody: 'Someone accepted your friend request on VScore.',

  // Tutorial
  tutorialSkip: 'Skip',
  tutorialNext: 'Next →',
  tutorialStart: "Let's go! 🚀",
  tutorialLanguageTitle: 'Welcome to V-Score! 🎮',
  ...
  tutorialCardLegendVscore: 'V-Score',
  ...
  tutorialHonestyBody: 'V-Score works because everyone plays honestly. Please respect these rules:',
...
const fr: Translations = {
  ...
  notifFriendAcceptedBody: "Quelqu'un a accepté ta demande d'ami sur VScore.",

  // Tutorial
  tutorialSkip: 'Passer',
  tutorialNext: 'Suivant →',
  tutorialStart: "C'est parti ! 🚀",
  tutorialLanguageTitle: 'Bienvenue sur V-Score ! 🎮',
  ...
  tutorialHonestyBody: 'V-Score fonctionne parce que tout le monde joue honnêtement. Respecte ces règles :',
